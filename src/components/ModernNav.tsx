...
export default function ModernNav() {
  ...
  return (
    <>
      {/* === Desktop / Tablet Top Nav with Contact Links === */}
      <nav
      ...
      {/* === Mobile Bottom Nav (Nav + Contact Together) === */}
      <nav
        className="md:hidden fixed top-0 left-0 right-0 z-50 border-t border-[var(--color-border)]
      ...
      {/* === Floating Scroll-aware Contact Bar (when top nav hides) === */}
      <AnimatePresence>
        {!showTop && (
          <motion.div
